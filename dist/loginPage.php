...
<head>
        ...
        <!-- Custom styles for this template from publishersdb -->
		    	...
		    	<div class="row align-items-center justify-content-between d-flex">
			      ...
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          ...
			          <li class="nav-item">
	                  		<a class="nav-link" href="loginPage.php">Login/SignUp</a>
                      </li>
			        </ul>
				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="loginPage.php"> Login</a></p>
						</div>
					</div>
				</div>
			</section>
