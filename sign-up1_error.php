...
<head>
		...
		<?php
			...
			{
			    if (isset($_POST['email'])) { //user logging in

			        require 'addAlumni.php';
		               ...
		               <li class="nav-item">
		               		<?php  
		               			if (isset($_SESSION['type'])){
		               				...
		               				echo '<a href="sign-up1.php">Sign Up</a>';
		               			}
		               		?>
				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="sign-up1.php">Register Alumni</a></p>
						</div>
					</div>
				</div>
			</section>
				...
				<h3>				
					<?php 
						if( isset($_SESSION['message']) AND !empty($_SESSION['message']) ): 
							echo '<font style="color: red;">'.$_SESSION['message'].'</font>';    
						else:
